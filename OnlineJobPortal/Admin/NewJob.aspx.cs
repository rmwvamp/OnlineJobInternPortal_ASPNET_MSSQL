    ...
    public partial class NewJob : System.Web.UI.Page
    {
        ...
        protected void OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                query = "Insert into Jobs values(@Title,@NumberofPosts,@Description,@Qualificaiton,@Experience,@Specialization," +
                ...
                cmd.Parameters.AddWithValue("@NumberofPosts", txtNumberofPosts.Text.Trim());
                cmd.Parameters.AddWithValue("@Description", txtDescription.Text.Trim());
                cmd.Parameters.AddWithValue("@Qualificaiton", txtQualification.Text.Trim());
